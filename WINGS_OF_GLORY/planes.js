...
const MISSILES = {
  ...
  // rearArc: how far off the target's tail an early IR seeker can still see the exhaust
  ...
  'aim-9b':  {art:'aim-9b-sidewinder', name:'AIM-9B Sidewinder', guidance:'ir',   rearOnly:true, rearArc:80,  speed:1500, accel:2000, boost:2.2, drag:200, turn:70,  fov:38, lockFov:30, range:1400, minRange:320, fuse:22, dmg:95,  life:5.5, lockTime:0.8, ccm:0.15},
  'aim-9d':  {art:'aim-9d-sidewinder', name:'AIM-9D Sidewinder', guidance:'ir',   rearOnly:true, rearArc:95,  speed:1700, accel:2200, boost:2.4, drag:190, turn:110, fov:48, lockFov:38, range:1700, minRange:300, fuse:24, dmg:110, life:6.0, lockTime:0.7, ccm:0.3},
  'aim-9e':  {art:'aim-9e-sidewinder', name:'AIM-9E Sidewinder', guidance:'ir',   rearOnly:true, rearArc:100,  speed:1650, accel:2100, boost:2.3, drag:190, turn:95,  fov:52, lockFov:42, range:1600, minRange:300, fuse:24, dmg:105, life:6.0, lockTime:0.6, ccm:0.35},
  'aim-4a':  {art:'aim-4a-falcon',     name:'AIM-4A Falcon',     guidance:'ir',   rearOnly:true, rearArc:70,  speed:1500, accel:1900, boost:1.8, drag:230, turn:60,  fov:32, lockFov:26, range:1300, minRange:340, fuse:0,  dmg:80,  life:5.0, lockTime:1.0, ccm:0.1},
  'aim-7':   {art:'aim-7b-sparrow',    name:'AIM-7B Sparrow',    guidance:'sarh', rearOnly:false, speed:1900, accel:2400, boost:3.0, drag:170, turn:80,  fov:60, lockFov:55, range:2600, minRange:500, fuse:30, dmg:140, life:8.0, lockTime:1.0, ccm:1},
  'aim-54':  {art:'aim-54c-phoenix',   name:'AIM-54C Phoenix',   guidance:'arh',  rearOnly:false, speed:2400, accel:2600, boost:4.5, drag:150, turn:85,  fov:65, lockFov:55, range:4200, minRange:800, fuse:36, dmg:200, life:11,  lockTime:1.4, ccm:1},
  'aim-120': {art:'aim-120-amraam',    name:'AIM-120 AMRAAM',    guidance:'arh',  rearOnly:false, speed:2300, accel:2800, boost:3.4, drag:150, turn:130, fov:70, lockFov:60, range:3600, minRange:600, fuse:30, dmg:170, life:9.0, lockTime:0.9, ccm:1},
  'r-3s':    {art:'r-3s-aa-2-atoll',   name:'R-3S Atoll',        guidance:'ir',   rearOnly:true, rearArc:78,  speed:1500, accel:1950, boost:2.1, drag:210, turn:65,  fov:36, lockFov:28, range:1300, minRange:330, fuse:20, dmg:95,  life:5.5, lockTime:0.9, ccm:0.12},
  'r-13':    {art:'k-13r-aa-2c-atoll', name:'R-13M Atoll',       guidance:'ir',   rearOnly:true, rearArc:95,  speed:1650, accel:2100, boost:2.4, drag:195, turn:100, fov:46, lockFov:38, range:1600, minRange:300, fuse:24, dmg:105, life:6.0, lockTime:0.7, ccm:0.3},
  'r-60':    {art:'r-60-vympel-aa-8-aphid',name:'R-60M Aphid',   guidance:'ir',   rearOnly:false, speed:1700, accel:2500, boost:1.6, drag:260, turn:150, fov:58, lockFov:50, range:1100, minRange:220, fuse:18, dmg:85,  life:4.5, lockTime:0.5, ccm:0.5},
  'r-23':    {art:'vympel-r-23-aa-7-apex',name:'R-23R Apex',     guidance:'sarh', rearOnly:false, speed:1900, accel:2400, boost:3.0, drag:175, turn:85,  fov:60, lockFov:55, range:2600, minRange:500, fuse:30, dmg:140, life:8.0, lockTime:1.0, ccm:1},
  'r-40':    {art:'r-40-aa-6-acrid',   name:'R-40D Acrid',       guidance:'sarh', rearOnly:false, speed:2200, accel:2500, boost:3.8, drag:160, turn:75,  fov:60, lockFov:55, range:3300, minRange:700, fuse:34, dmg:180, life:9.0, lockTime:1.2, ccm:1},
  'r-4':     {art:'r-4t-aa-5-ash',     name:'R-4T Ash',          guidance:'ir',   rearOnly:true, rearArc:80,  speed:1600, accel:1900, boost:2.6, drag:210, turn:60,  fov:38, lockFov:30, range:2000, minRange:450, fuse:28, dmg:130, life:7.0, lockTime:1.0, ccm:0.15},
  'aa-3':    {art:'k-8-kalingrad-aa-3-anab',name:'R-8T Anab',    guidance:'ir',   rearOnly:true, rearArc:82,  speed:1600, accel:1950, boost:2.4, drag:205, turn:65,  fov:40, lockFov:32, range:1900, minRange:420, fuse:26, dmg:120, life:7.0, lockTime:0.9, ccm:0.18},
