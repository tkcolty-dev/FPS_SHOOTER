    ...
    <div>
      ...
      <button
        ...
        onClick={() => {
          ...
          const mealType = hour < 11 ? 'breakfast' : hour < 14 ? 'lunch' : hour < 18 ? 'snack' : 'dinner';
          const remaining = dailyGoal - totalCalories;
          const msg = `What should I eat for ${mealType}? I have ${remaining} calories left today.`;
          localStorage.setItem('chat-prefill', msg);
          navigate('/chat');
        }}
      >
