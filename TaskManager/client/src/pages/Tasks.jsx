        ...
        <div className="modal-overlay" onClick={(e) => e.target === e.currentTarget && resetForm()}>
          <div className="modal">
            ...
            <form onSubmit={handleSubmit}>
              <div className="modal-body">
                <div className="form-group"><label>Title</label><div className="voice-input-wrap"><input type="text" value={form.title} onChange={e => setForm({ ...form, title: e.target.value })} placeholder={voiceListening ? 'Listening...' : 'What needs to be done?'} required autoFocus />{hasSpeech && <button type="button" className={`voice-btn${voiceListening ? ' active' : ''}`} onClick={() => toggleVoice('title')}><IconMic size={16} /></button>}</div></div>
